...
XS_EUPXS(XS_Devel__PPPort_XSRETURN_UV)
{
    ...
    SP -= items;
    {
#line 1211 "RealPPPort.xs"
		XSRETURN_UV(42);
#line 2278 "RealPPPort.c"
	PUTBACK;
	return;
    }
}
